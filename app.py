...
.card { padding:16px; border-radius:14px; margin-bottom:12px; background:white; box-shadow:0 3px 8px rgba(0,0,0,0.06); }
.kpi { padding:12px; border-radius:12px; text-align:center; color:white; font-weight:bold; }
